...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="刘畅"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="18788888888"/>
		<input type="hidden" name="orderShipping.receiverState" value="成都"/>
		<input type="hidden" name="orderShipping.receiverCity" value="成都"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="犀浦"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="交大 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">刘畅</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">187****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">成都 西南交通大学</div>
						<div class="adr-m" limit="30">鸿哲斋 xxxxxxxxx</div>
